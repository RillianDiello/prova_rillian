 ...
 * @method \App\Model\Entity\Locai newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\Locai[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\Locai|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Locai patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\Locai[] patchEntities($entities, array $data, array $options = [])
